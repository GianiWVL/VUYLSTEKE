...
{
    public class TurnOverObjectCollection : CollectionBase, IBindingList
    {
        #region Fields
        ...
        public TurnOverObjectCollection()
        {
        }
        ...
        public TurnOverObject this[int index]
        {
            get
            {
                return (TurnOverObject)(List[index]);
            }
            set
            {
                List[index] = value;
        ...
        public TurnOverObject AddNew()
        {
            try
            {
                return (TurnOverObject)((IBindingList)this).AddNew();
            }
            catch (System.Exception exception1)
            {
                Exception innerException = exception1;
        ...
        protected override void OnClear()
        {
            try
            {
                foreach (TurnOverObject turnOver in List)
                {
                    turnOver.Parent = null;
                }
            }
            catch (System.Exception exception1)
            {
