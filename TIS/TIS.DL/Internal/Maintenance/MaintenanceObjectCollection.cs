...
{
    public class MaintenanceObjectCollection : CollectionBase, IBindingList
    {
        #region Fields
        ...
        public MaintenanceObjectCollection()
        {
        }
        ...
        public MaintenanceObject this[int index]
        {
            get
            {
                return (MaintenanceObject)(List[index]);
            }
            set
            {
                List[index] = value;
        ...
        public MaintenanceObject AddNew()
        {
            try
            {
                return (MaintenanceObject)((IBindingList)this).AddNew();
            }
            catch (System.Exception exception1)
            {
                Exception innerException = exception1;
        ...
        public MaintenanceObjectCollection GetActive()
        {
            try
            {
                ...
                foreach (MaintenanceObject maintenance in this)
                {
        ...
        protected override void OnClear()
        {
            try
            {
                foreach (MaintenanceObject Maintenance in List)
                {
                    Maintenance.Parent = null;
                }
            }
            catch (System.Exception exception1)
            {
