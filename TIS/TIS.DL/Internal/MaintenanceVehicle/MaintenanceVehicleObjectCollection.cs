...
{
    public class MaintenanceVehicleObjectCollection : CollectionBase, IBindingList
    {
        #region Fields
        ...
        public MaintenanceVehicleObjectCollection()
        {
        }
        ...
        public MaintenanceVehicleObject this[int index]
        {
            get
            {
                return (MaintenanceVehicleObject)(List[index]);
            }
            set
            {
                List[index] = value;
        ...
        public MaintenanceVehicleObject AddNew()
        {
            try
            {
                return (MaintenanceVehicleObject)((IBindingList)this).AddNew();
            }
            catch (System.Exception exception1)
            {
                Exception innerException = exception1;
        ...
        protected override void OnClear()
        {
            try
            {
                foreach (MaintenanceVehicleObject MaintenanceVehicle in List)
                {
                    MaintenanceVehicle.Parent = null;
                }
            }
            catch (System.Exception exception1)
            {
