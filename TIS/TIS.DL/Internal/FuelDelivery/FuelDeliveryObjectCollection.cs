...
{
    public class FuelDeliveryObjectCollection : CollectionBase, IBindingList
    {
        #region Fields
        ...
        public FuelDeliveryObjectCollection()
        {
        }
        ...
        public FuelDeliveryObject this[int index]
        {
            get
            {
                return (FuelDeliveryObject)(List[index]);
            }
            set
            {
                List[index] = value;
        ...
        public FuelDeliveryObject AddNew()
        {
            try
            {
                return (FuelDeliveryObject)((IBindingList)this).AddNew();
            }
            catch (System.Exception exception1)
            {
                Exception innerException = exception1;
        ...
        protected override void OnClear()
        {
            try
            {
                foreach (FuelDeliveryObject FuelDelivery in List)
                {
                    FuelDelivery.Parent = null;
                }
            }
            catch (System.Exception exception1)
            {
