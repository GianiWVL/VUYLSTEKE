...
{
    public class LanguageObjectCollection : CollectionBase, IBindingList
    {
        #region Fields
        ...
        public LanguageObjectCollection()
        {
        }
        ...
        public LanguageObject this[int index]
        {
            get
            {
                return (LanguageObject)(List[index]);
            }
            set
            {
                List[index] = value;
        ...
        public LanguageObject AddNew()
        {
            try
            {
                return (LanguageObject)((IBindingList)this).AddNew();
            }
            catch (System.Exception exception1)
            {
                Exception innerException = exception1;
        ...
        protected override void OnClear()
        {
            try
            {
                foreach (LanguageObject Language in List)
                {
