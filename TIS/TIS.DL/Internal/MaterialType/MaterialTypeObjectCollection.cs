...
{
    public class MaterialTypeObjectCollection : CollectionBase, IBindingList
    {
        #region Fields
        ...
        public MaterialTypeObjectCollection()
        {
        }
        ...
        public MaterialTypeObject this[int index]
        {
            get
            {
                return (MaterialTypeObject)(List[index]);
            }
            set
            {
                List[index] = value;
        ...
        public MaterialTypeObject AddNew()
        {
            try
            {
                return (MaterialTypeObject)((IBindingList)this).AddNew();
            }
            catch (System.Exception exception1)
            {
                Exception innerException = exception1;
        ...
        protected override void OnClear()
        {
            try
            {
                foreach (MaterialTypeObject MaterialType in List)
                {
