...
namespace TIS.DL.Internal.Customer
{
    ...
    public class CustomerObject : PROF_IT.DLM.DL.BaseObject, IEditableObject
    {
        #region Constructor
        ...
        private CustomerObjectCollection _parent;
        private PROF_IT.Common.Enumerations.ObjectState _state = PROF_IT.Common.Enumerations.ObjectState.Loaded;
        ...
        internal CustomerObjectCollection Parent
        {
            get
            {
                return _parent;
        ...
        #region Methods
        public CustomerObject Clone()
        {
            return this.Clone<CustomerObject>(this);
        }
        ...
        public override bool Equals(object obj)
        {
            try
            {
                if (this.CusID == ((CustomerObject)obj).CusID)
                    return true;
                else
                    return false;
            }
        ...
        private void OnCustomerObjectChanged()
        {
            try
            {
                if (inTxn && Parent != null)
                {
                    Parent.CustomerObjectChanged(this);
                }
            }
            catch (System.Exception exception1)
            {
