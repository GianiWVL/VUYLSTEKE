...
namespace TIS.DL.Internal.Schedule
{
    ...
    public class ScheduleObjectCollection : CollectionBase, IBindingList
    {
        #region Fields
        ...
        public ScheduleObjectCollection()
        {
        }
        ...
        public ScheduleObject this[int index]
        {
            get
            {
                return (ScheduleObject)(List[index]);
            }
            set
            {
                List[index] = value;
        ...
        public ScheduleObject AddNew()
        {
            try
            {
                return (ScheduleObject)((IBindingList)this).AddNew();
            }
            catch (System.Exception exception1)
            {
                Exception innerException = exception1;
        ...
        protected override void OnClear()
        {
            try
            {
                foreach (ScheduleObject schedule in List)
                {
