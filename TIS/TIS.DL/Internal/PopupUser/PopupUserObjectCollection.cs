...
{
    public class PopupUserObjectCollection : CollectionBase, IBindingList
    {
        ...
        public PopupUserObjectCollection()
        {
        }
        ...
        public PopupUserObject this[int index]
        {
            get
            {
                return (PopupUserObject)(List[index]);
            }
            set
            {
                List[index] = value;
        ...
        public PopupUserObject AddNew()
        {
            try
            {
                return (PopupUserObject)((IBindingList)this).AddNew();
            }
            catch (System.Exception exception1)
            {
                Exception innerException = exception1;
        ...
        protected override void OnClear()
        {
            try
            {
                foreach (PopupUserObject popupUser in List)
                {
                    popupUser.Parent = null;
                }
            }
            catch (System.Exception exception1)
            {
