...
namespace TIS.DL.Internal.ParameterSystem
{
    ...
    public class ParameterSystemObjectCollection: CollectionBase, IBindingList
    {
        #region Fields
        ...
        public ParameterSystemObjectCollection()
        {
        }
        ...
        public ParameterSystemObject this[int index]
        {
            get
            {
                return (ParameterSystemObject)(List[index]);
            }
            set
            {
                List[index] = value;
        ...
        public ParameterSystemObject AddNew()
        {
            try
            {
                return (ParameterSystemObject)((IBindingList)this).AddNew();
            }
            catch (System.Exception exception1)
            {
                Exception innerException = exception1;
        ...
        protected override void OnClear()
        {
            try
            {
                foreach (ParameterSystemObject parameterSystem in List)
                {
                    parameterSystem.Parent = null;
                }
            }
            catch (System.Exception exception1)
            {
