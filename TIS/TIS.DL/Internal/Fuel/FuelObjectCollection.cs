...
{
    public class FuelObjectCollection : CollectionBase, IBindingList
    {
        #region Fields
        ...
        public FuelObject this[int index]
        {
            get
            {
                return (FuelObject)(List[index]);
            }
            set
            {
                List[index] = value;
        ...
        public FuelObject AddNew()
        {
            try
            {
                return (FuelObject)((IBindingList)this).AddNew();
            }
            catch (System.Exception exception1)
            {
                Exception innerException = exception1;
        ...
        protected override void OnClear()
        {
            try
            {
                foreach (FuelObject Fuel in List)
                {
                    Fuel.Parent = null;
                }
            }
