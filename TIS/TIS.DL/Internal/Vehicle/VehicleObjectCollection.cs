...
{
    public class VehicleObjectCollection : CollectionBase, IBindingList
    {
        #region Fields
        ...
        public VehicleObjectCollection()
        {
        }
        ...
        public VehicleObject this[int index]
        {
            get
            {
                return (VehicleObject)(List[index]);
            }
            set
            {
                List[index] = value;
        ...
        public VehicleObject AddNew()
        {
            try
            {
                return (VehicleObject)((IBindingList)this).AddNew();
            }
            catch (System.Exception exception1)
            {
                Exception innerException = exception1;
        ...
        protected override void OnClear()
        {
            try
            {
                foreach (VehicleObject Vehicle in List)
                {
                    Vehicle.Parent = null;
                }
            }
