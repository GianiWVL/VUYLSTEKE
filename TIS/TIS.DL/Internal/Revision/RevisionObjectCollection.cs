...
{
    public class RevisionObjectCollection : CollectionBase, IBindingList
    {
        #region Fields
        ...
        public RevisionObjectCollection()
        {
        }
        ...
        public RevisionObject this[int index]
        {
            get
            {
                return (RevisionObject)(List[index]);
            }
            set
            {
                List[index] = value;
        ...
        public RevisionObject AddNew()
        {
            try
            {
                return (RevisionObject)((IBindingList)this).AddNew();
            }
            catch (System.Exception exception1)
            {
                Exception innerException = exception1;
        ...
        protected override void OnClear()
        {
            try
            {
                foreach (RevisionObject Revision in List)
                {
        ...
        protected override void OnInsertComplete(int index, object value)
        {
            try
            {
                RevisionObject Revision = (RevisionObject)value;
        ...
        protected override void OnSetComplete(int index, object oldValue, object newValue)
        {
            try
            {
                ...
                {
                    RevisionObject oldRevision = (RevisionObject)oldValue;
                    RevisionObject newRevision = (RevisionObject)newValue;
                    oldRevision.Parent = null;
                    newRevision.Parent = this;
