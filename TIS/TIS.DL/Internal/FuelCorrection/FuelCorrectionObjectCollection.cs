...
{
    public class FuelCorrectionObjectCollection : CollectionBase, IBindingList
    {
        #region Fields
        ...
        public FuelCorrectionObjectCollection()
        {
        }
        ...
        public FuelCorrectionObject this[int index]
        {
            get
            {
                return (FuelCorrectionObject)(List[index]);
            }
            set
            {
                List[index] = value;
        ...
        public FuelCorrectionObject AddNew()
        {
            try
            {
                return (FuelCorrectionObject)((IBindingList)this).AddNew();
            }
            catch (System.Exception exception1)
            {
                Exception innerException = exception1;
        ...
        protected override void OnClear()
        {
            try
            {
                foreach (FuelCorrectionObject Fuel in List)
                {
                    Fuel.Parent = null;
                }
            }
