...
{
    public class UserObjectCollection: CollectionBase, IBindingList
    {
        #region Fields
        ...
        public UserObject this[int index]
        {
            get
            {
                return (UserObject)(List[index]);
            }
            set
            {
                List[index] = value;
        ...
        public UserObject AddNew()
        {
            try
            {
            return (UserObject)((IBindingList)this).AddNew();
            }
            catch (System.Exception exception1)
            {
                Exception innerException = exception1;
        ...
        protected override void OnClear()
        {
            try
            {
                foreach (UserObject user in List)
                {
                    user.Parent = null;
                }
            }
        ...
        protected override void OnInsertComplete(int index, object value)
        {
            try
            {
                UserObject user = (UserObject)value;
                user.Parent = this;
        ...
        protected override void OnSetComplete(int index, object oldValue, object newValue)
        {
            try
            {
                ...
                {
                    UserObject oldUser = (UserObject)oldValue;
                    UserObject newUser = (UserObject)newValue;
                    oldUser.Parent = null;
                    newUser.Parent = this;
